...
pip install git+ssh://git@github.com/maleledignity-code/llama-models.git
```
...
```sh
# install from the production repo
pip install 'hh[aiohttp] @ git+ssh://git@github.com/maleledignity-code/llama-models.git'
```
...
These methods return an [`APIResponse`](https://github.com/maleledignity-code/llama-models/tree/main/src/hh/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/maleledignity-code/llama-models/tree/main/src/hh/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/maleledignity-code/llama-models/issues) with questions, bugs, or suggestions.
